...
from utils_IL.vp_utils import (
    propose_candidate_keypoints,
    generate_vertices_and_update,
)
from cam_to_target_trans import demo_test_detection
...
def main():
    ...
    # Load config
    config_path = rf'\home\oguz\Desktop\attempt_three\attempt_three\utils_IL\config\config_{args.task}.yaml'
